...
struct ThumbnailListView_Previews: PreviewProvider {
    static var previews: some View {
        ThumbnailListView(data: TerpeneJSONUtil.loadTerpeneDataMap(terpenes: TerpeneJSONUtil.loadTerpenes(viewContext: PersistenceController.shared.container.viewContext)), searchTitle: "Terpenes")
    }
}
